...
document.addEventListener("keydown", (event) => {
    ...
    if (["ArrowUp"].includes(key)) {
        let player1Score = parseInt(document.getElementById("player1ScoreId").textContent);
        player1Score += 1;
        document.getElementById("player1ScoreId").textContent = player1Score.toString();
        // console.log(player1Score);
        getEmotion();
    }
    if (["ArrowDown"].includes(key)) {
        let player2Score = parseInt(document.getElementById("player2ScoreId").textContent);
        player2Score += 1;
        document.getElementById("player2ScoreId").textContent = player2Score.toString();
        getEmotion();
    }
});
getEmotion();
