...
let player1IconContest = document.querySelector(".player1ScoreContest");
let player2Icon = document.getElementById("player2IconId");
let player2IconContest = document.querySelector(".player2ScoreContest");
...
function resetEmotions() {
    ...
    changeEmotion(player1IconContest, "happy");
    document.getElementById("player1ScoreId").textContent = "0";
    document.getElementById("player2ScoreId").textContent = "0";
    document.querySelector(".player1ScoreContest").textContent = "0";
    document.querySelector(".player2ScoreContest").textContent = "0";
}
function setGameScore(name1, name2 = "Bot") {
    let player1Nick = document.getElementById("player1NickId");
    let player1NickContest = document.querySelector(".player1NickContest");
    let player2Nick = document.getElementById("player2NickId");
    let player2NickContest = document.querySelector(".player2NickContest");
...
window.addEventListener("gameStateUpdate", (event) => {
    state2 = event.detail;
    if (state2) {
        document.getElementById("player1ScoreId").textContent = state2.score.p1;
        document.getElementById("player2ScoreId").textContent = state2.score.p2;
        document.querySelector(".player1ScoreContest").textContent = state2.score.p1;
        document.querySelector(".player2ScoreContest").textContent = state2.score.p2;
        getEmotion();
    }
});
